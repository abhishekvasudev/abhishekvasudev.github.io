  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col items-center justify-center pt-36 pb-20 px-4 text-center overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto z-10 flex flex-col items-center">
        <h1 className="sr-only">Abhishek Vasudev</h1>
        <p
          aria-hidden="true"
          className="font-serif text-5xl md:text-7xl lg:text-[84px] font-normal tracking-tight leading-[1.08] mb-1 px-4 drop-shadow-[0_2px_15px_rgba(0,0,0,0.4)]"
        >
